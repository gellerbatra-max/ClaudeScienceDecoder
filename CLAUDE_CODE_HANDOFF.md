...
| `plaid/` | (2026-09-25) two plaid markers, the ZZ-PLAID matching table and the engine's `frommed.mra` of job 117: the plaid / stripe doubles of section 1; sections 9 / 23 / 24 = the matching rules (v4.25: five markers + the engine's `frommed.mra` of each job) |
